...
function App() {
  const content = {
    ...
    contact: '📞 አግኙን',
    home: '🏠 መነሻ',
    welcome: '👕 ኤን ኤ ዲ ጨርቃጨርቅና አልባሳት ትሬዲንግ አክሲዮን ማኅበር',
    description: '🎯 ጥራት፣ ፈጠራ እና ታማኝነት በማጣመር የቀረበ እጅግ የተሻለ አምራችነት።',
    aboutText: '🏭 ኤን ኤ ዲ ጨርቃጨርቅና አልባሳት ትሬዲንግ አክሲዮን ማኅበር በሸገር ከተማ በለገጣፎ የሚገኝ ዘመናዊ ሥነ-ምህዳር ላይ የሚገኝ ጨርቃጨርቅና አልባሳት አምራች ነው። 🚀 የላቀ ቴክኖሎጂን ከዘላቂ የአመራረት ልምዶች ጋር በማጣመር ለሀገር ውስጥ እና ለአለም አቀፍ ገበያዎች ከፍተኛ ጥራት ያላቸውን ጨርቆች እና አልባሳት በማምረት ላይ እንሰራለን።',
    ...
    testimonialsText1: '♻️ ብዙ ሁነን አንድ አንድ ሁነን ብዙ ተቋማትን እንገነባለን',
    testimonialsText2: '💎 Unity is strength diversity is power',
    contactForm: '✉️ አግኙን'
  };
    ...
    <div className="App">
      <header>
        ...
        <div className="hero-image">
          <img src="2.jpg" alt="Hero" style={{ width: '90%', height: 'auto' }} />
        </div>
      </header>
      <main>
