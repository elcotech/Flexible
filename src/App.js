...
function App() {
  const content = {
    ...
    aboutText: '🏭 ናድ ጨርቃጨርቅና አልባሳት ትሬዲንግ አክሲዮን ማኅበር በሸገር ከተማ በለገጣፎ የሚገኝ ዘመናዊ ሥነ-ምህዳር ጨርቃጨርቅና አልባሳት አምራች ነው። 🚀 የላቀ ቴክኖሎጂን ከዘላቂ የአመራረት ልምዶች ጋር በማጣመር ለሀገር ውስጥ እና ለአለም አቀፍ ገበያዎች ከፍተኛ ጥራት ያላቸውን ጨርቆች እና አልባሳት በማምረት ላይ እንሰራለን።',
