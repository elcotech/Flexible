...
function App() {
  const content = {
    ...
    aboutText: '🏭 ናድ ጨርቃጨርቅና አልባሳት ትሬዲንግ አክሲዮን ማኅበር በሸገር ከተማ በለገጣፎ የሚገኝ ዘመናዊ ሥነ-ምህዳር ላይ የሚገኝ ጨርቃጨርቅና አልባሳት አምራች ነው። 🚀 የላቀ ቴክኖሎጂን ከዘላቂ የአመራረት ልምዶች ጋር በማጣመር ለሀገር ውስጥ እና ለአለም አቀፍ ገበያዎች ከፍተኛ ጥራት ያላቸውን ጨርቆች እና አልባሳት በማምረት ላይ እንሰራለን።',
    ...
    testimonialsText1: '♻️ ምስሎቹን አካቴትና ብዙ ሁነን አንድ አንድ ሁነን ብዙ ተቋማትን እንገነባለን መፈክር መግበት አለበት',
